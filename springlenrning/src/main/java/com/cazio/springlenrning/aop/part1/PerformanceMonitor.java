/**
 * Created on [2020/4/2 10:16] by Administrator
 * <p>
...
public class PerformanceMonitor {
    private static final ThreadLocal<MethodPerformance> threadLocal = new ThreadLocal<MethodPerformance>();

    public static void begin(String method) {
        System.out.println("开始监控--->" + method);
